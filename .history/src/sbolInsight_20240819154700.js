    ...
    return (
        ...
        >
            ...
            <Box
                ...
                <Box sx={{ position: 'absolute', top: 0, left: 0, width: 100, height: 100, backgroundColor: 'red' }} />
                <Box sx={{ position: 'absolute', top: 50, left: 50, width: 100, height: 100, backgroundColor: 'green', zIndex: 1 }} />
                <Box sx={{ position: 'absolute', bottom: 0, right: 0, width: 100, height: 100, backgroundColor: 'blue' }} />
            </Box>
